  ...
  return (
    <div className="rounded-xl border border-dashed border-[#F1D9D0] bg-[#FFF8F0] p-4">
      ...
      <div className="mt-2 flex items-center gap-4">
        {preview && <img src={preview} alt="preview" className="w-20 h-20 rounded-xl object-cover border" />}
        <div>
          ...
          <div className="text-[10px] text-[#3D4A5E]/70 mt-1">JPG/PNG up to 5MB. Saved to /public/uploads → usable in heroImage, gallery</div>
        </div>
      </div>
    </div>
  );
