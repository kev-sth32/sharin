  ...
  return (
    <div>
      ...
      <div className="mt-8 grid md:grid-cols-3 lg:grid-cols-6 gap-4">
        <Link href="/admin24639/leads" className="rounded-2xl bg-white border border-[#F1D9D0] p-5 hover:border-[#FF4A7D]/30 transition">
        ...
        <Link href="/admin24639/trips" className="rounded-2xl bg-white border border-[#F1D9D0] p-5 hover:border-[#FF4A7D]/30 transition">
        ...
        <Link href="/admin24639/testimonials" className="rounded-2xl bg-white border border-[#F1D9D0] p-5">
        ...
        <Link href="/admin24639/finance" className="rounded-2xl bg-[#FFF8F0] border border-[#FF8A2B]/20 p-5 hover:border-[#FF8A2B]/40 transition">
            ...
            <div className="mt-4 space-y-3 max-h-[380px] overflow-y-auto">
              {data.leads.slice(0,6).map((l: any)=>(
                <div key={l.id} className="flex items-center justify-between gap-4 rounded-xl border border-[#F1D9D0] p-3">
                  ...
                  <Link href="/admin24639/leads" className="rounded-full bg-[#13253D] text-white px-3 py-1.5 text-[11px]">Open CRM</Link>
                </div>
              ))}
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="rounded-[20px] bg-[#13253D] text-white p-6">
            ...
            <ul className="mt-4 space-y-2 text-xs text-white/80 leading-relaxed">
              <li>✅ <Link href="/admin24639/trips" className="underline text-[#FF8A2B]">Trip Packages</Link> — Toggle Featured, Publish/Draft, Edit price, SEO</li>
              <li>✅ <Link href="/admin24639/leads" className="underline text-[#FF8A2B]">Leads CRM</Link> — Change status (New→Booked), add notes, follow-up date, WhatsApp log</li>

              <li>✅ <Link href="/admin24639/testimonials" className="underline text-[#FF8A2B]">Testimonials</Link> — Approve/reject, feature, add new</li>
              <li>✅ <Link href="/admin24639/blogs" className="underline text-[#FF8A2B]">Blogs</Link> — Create new resource posts</li>
              <li>✅ <Link href="/admin24639/policies" className="underline text-[#FF8A2B]">Policies</Link> — Version history, last updated</li>
              <li>✅ <Link href="/admin24639/contacts" className="underline text-[#FF8A2B]">Contacts & Refunds</Link> — Resolve, add admin notes</li>
            </ul>
          ...
          <div className="rounded-[20px] bg-white border border-[#F1D9D0] p-6">
            ...
            <div className="mt-3 grid grid-cols-2 gap-2">
              <Link href="/admin24639/trips" className="rounded-xl bg-[#FFF8F0] border border-[#F1D9D0] p-3 text-xs font-semibold hover:bg-[#FFF0F4]">+ New Trip</Link>
              <Link href="/admin24639/blogs" className="rounded-xl bg-[#FFF8F0] border border-[#F1D9D0] p-3 text-xs font-semibold hover:bg-[#FFF0F4]">+ Blog Post</Link>
              <Link href="/admin24639/testimonials" className="rounded-xl bg-[#FFF8F0] border border-[#F1D9D0] p-3 text-xs font-semibold hover:bg-[#FFF0F4]">+ Testimonial</Link>
            </div>
          </div>
        </div>
      </div>
